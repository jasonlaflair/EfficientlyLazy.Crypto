...
namespace EfficientlyLazyCrypto
{
    ...
    ///</summary>
    internal class DPAPINative_Methods
    {
        ///<summary>
        /// Performs encryption on the data in a <see cref="DPAPINative_DATA_BLOB"/> structure
        ///</summary>
        ...
        public bool ProtectData(ref DPAPINative_DATA_BLOB plainText,
                                string description,
                                ref DPAPINative_DATA_BLOB entropy,
                                IntPtr reserved,
                                ref DPAPINative_CRYPTPROTECT_PROMPTSTRUCT prompt,
                                int flags,
                                ref DPAPINative_DATA_BLOB cipherText)
        {
        ...
        private static extern bool CryptProtectData(ref DPAPINative_DATA_BLOB plainText,
                                                    string description,
                                                    ref DPAPINative_DATA_BLOB entropy,
                                                    IntPtr reserved,
                                                    ref DPAPINative_CRYPTPROTECT_PROMPTSTRUCT prompt,
        ...
        ///<summary>
        /// Decrypts and does an integrity check of the data in a <see cref="DPAPINative_DATA_BLOB"/> structure
        ///</summary>
        ...
        ///<returns>If the function succeeds, then <c>TRUE</c> else <c>FALSE</c>.</returns>
        public bool UnprotectData(ref DPAPINative_DATA_BLOB cipherText,
                                  ref string description,
                                  ref DPAPINative_DATA_BLOB entropy,
                                  IntPtr reserved,
                                  ref DPAPINative_CRYPTPROTECT_PROMPTSTRUCT prompt,
                                  int flags,
                                  ref DPAPINative_DATA_BLOB plainText)
        {
        ...
        [DllImport("crypt32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        [return: MarshalAs(UnmanagedType.Bool)]
        private static extern bool CryptUnprotectData(ref DPAPINative_DATA_BLOB cipherText,
                                                      ref string description,
                                                      ref DPAPINative_DATA_BLOB entropy,
                                                      IntPtr reserved,
                                                      ref DPAPINative_CRYPTPROTECT_PROMPTSTRUCT prompt,
