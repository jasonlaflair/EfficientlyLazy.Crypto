...
namespace EfficientlyLazy.Crypto.Configuration
{
    ...
    ///<summary>
    ///</summary>
    public class SecureCollection<T> : ICollection<T> where T : ISecureSetting
    {
        ...
        public T this[string key]
        {
            get
            {
                ...
                // not using linq for v2.0 compatability
                //return _list.Where(x => x.Key == key).FirstOrDefault();
            }
        }
